...
//первостепенные
//todo добавить евент алтарю
//todo добавить окно с наградами
//todo не работают бафы от шмоток
//todo добавить дроп шомта при смерте
//todo разобраться с багованной кнопкой в инвентаре
//todo допилить логику передвижения
//todo добавить разные батл бэкграунды
//todo перенести мировую логику из player в world
//todo добавить эвент городу и таверне - востанавливает хп

//недалекое будущее
//todo улетает камера после выхода из боя - сделать фокус на игрока
//todo ограничить камеру в границах карты
//todo добавить мини менюшку и загрузочный экран на время пока подгружаются текстуры
...
//это уже фантастика
//todo добавить описание и подсказки для игрока
//todo добавить финальных мощных боссов
//todo добавить звуки
