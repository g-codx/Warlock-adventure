...
//TODO
/*
Сделать инвентарь где игрок может хранить любое кол-во карт и предметов
Сделать боевую колоду где игрок выбирает конкретные карты под определенный бой
Сделать оганичения по картам в бою
    3 простые карты
    2 средние
    1 специальная/ультимативаная дорого стоит имеет много урона
Сделать стейт где можно выбирать шмот и колоды под бой
Выбранные шмотки и колода определяют стратегию
Сделать обычных мобов на которых игрок будет фармить
Сделать особых рарных мобов с разными механиками и редкой наградой
 */
